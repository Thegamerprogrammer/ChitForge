...
export async function generateMission({ form, sliders, selectedTargets, targetingMode, includeFollowUp, onProgress }) {
  ...
  return normalizeMission(text, { sliders, includeFollowUp });
}
...
function buildMissionPrompt({ form, sliders, selectedTargets, targetingMode, includeFollowUp }) {
...
Return schema:
{
  ...
  "chits": [{
    ...
    "evidence":[{"title":"...","organization":"...","date":"...","url":"...","sourceClassification":"PRIMARY | HIGH-QUALITY SECONDARY | OTHER","claim":"What source establishes"}],
